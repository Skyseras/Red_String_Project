    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 blog-single">
          ...
          <p>
            <img src="<?php echo URLROOT; ?>/public/img/xbg_1.jpg.pagespeed.ic.b31fPYrhFV.jpg" alt="" class="img-fluid">
          </p>
          ...
          <p>
            <img src="<?php echo URLROOT; ?>/public/img/ximage_3.jpg.pagespeed.ic.CWHmT1gFhf.jpg" alt="" class="img-fluid">
          </p>
          ...
          <div class="about-author d-flex p-4 bg-light rounded">
            <div class="bio mr-5">
              <img src="<?php echo URLROOT; ?>/public/img/xperson_1.jpg.pagespeed.ic.P4pHl6glbj.jpg" alt="Image placeholder" class="img-fluid mb-4">
            </div>
            <div class="desc">
          ...
          <div class="pt-5 mt-5">
            ...
            <ul class="comment-list">
              <li class="comment">
                <div class="vcard bio">
                  <img src="<?php echo URLROOT; ?>/public/img/xperson_1.jpg.pagespeed.ic.P4pHl6glbj.jpg" alt="Image placeholder">
                </div>
        ...
        <div class="col-lg-4 sidebar pl-md-4">
          ...
          <div class="sidebar-box">
            ...
            <div class="block-21 mb-4 d-flex">
              <a class="blog-img mr-4" style="background-image:url(<?php echo URLROOT; ?>/public/img/ximage_1.jpg.pagespeed.ic.Yc6gAsaZ2Y.jpg)"></a>
              <div class="text">
            ...
            <div class="block-21 mb-4 d-flex">
              <a class="blog-img mr-4" style="background-image:url(<?php echo URLROOT; ?>/public/img/ximage_2.jpg.pagespeed.ic.mQGyn1P_Li.jpg)"></a>
              <div class="text">
                <h3 class="heading"><a href="#">Far far away, behind the word mountains</a></h3>
                <div class="meta">
                  <div><a href="#"><span class="fa fa-calendar"></span> December 02, 2020</a></div>
            ...
            <div class="block-21 mb-4 d-flex">
              <a class="blog-img mr-4" style="background-image:url(<?php echo URLROOT; ?>/public/img/ximage_3.jpg.pagespeed.ic.CWHmT1gFhf.jpg)"></a>
              <div class="text">
                <h3 class="heading"><a href="#">Far far away, behind the word mountains</a></h3>
                <div class="meta">
                  <div><a href="#"><span class="fa fa-calendar"></span> December 02, 2020</a></div>
