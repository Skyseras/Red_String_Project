                                        ...
                                        <div class="card-body py-1 px-0">
                                            <div class="row report-inner-cards-wrapper p-0">
                                                <div class="col-md-4 col-xl-4 report-inner-card">
                                                    <div class="inner-card-icon bg-primary ml-0 mr-4">
                                                ...
                                                <div class="col-md-2 col-xl-2 report-inner-card">
                                                    <button type="button" class="inner-card-icon btn btn-inverse-primary btn-icon">
                                                        <i class="icon-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        foreach ($data['agences'] as $row) {
                                            ...
                                            <td>
                                                <a class="btn-edit" type="button" data-bs-toggle="modal" data-bs-target="#editModal">
                                                    <div class="badge badge-primary p-2 icon-pencil">Edit</div>
                                                </a>
                                                <a class="btn-delete" type="button" data-bs-toggle="modal" data-bs-target="#deleteModal">
                                                    <div class="badge badge-primary p-2 icon-trash">Delete</div>
                                                </a>
                                            </td>
                                        </tr>';
                                        }
