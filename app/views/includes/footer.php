        ...
        <div class="row mb-5 pb-5 justify-content-between">
            ...
            <div class="col-md-6 col-lg-2">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="#"><span class="fa fa-chevron-right mr-2"></span>Termes&amp;Conditions</a></li>
                        <li><a href="#"><span class="fa fa-chevron-right mr-2"></span>Guide de l'utilisateur</a></li>
                        <li><a href="#"><span class="fa fa-chevron-right mr-2"></span>Support Center</a></li>
                        <li><a href="#"><span class="fa fa-chevron-right mr-2"></span>Info presse</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-6 col-lg">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon fa fa-map marker"></span><span class="text">Bureau 7 Jozefine Centre Majorelle Marrakech</span></li>
                            <li><a href="#"><span class="icon fa fa-phone"></span><span class="text">+212 708 884 824</span></a></li>
                            <li><a href="#"><span class="icon fa fa-paper-plane pr-4"></span><span class="text"><span class="__cf_email__" data-cfemail="422b2c242d023b2d3730262d2f232b2c6c212d2f">[info@immomaroc.ma, email&#160;protected]</span></span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p class="mb-0" style="color: rgba(255,255,255,.5); font-size: 13px;">Copyright &copy;<script data-cfasync="false" src="../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
                        ...
                        </script> All rights reserved | Powered with <i class="fa fa-heart color-danger" aria-hidden="true"></i> by <a href="#" target="_blank" rel="nofollow noopener">ImmoMaroc</a>
                </div>
            </div>
        </div>
    </div>
